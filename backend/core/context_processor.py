...
def user_profile(request):
    """ Adds user profile information to the context if the user is authenticated. """
...
def property_list(request):
    """ Provides a list of properties to the context, potentially for a homepage or listing page. """
...
def site_settings(request):
    """ Adds site settings to the context, such as site name and other configurations. """
    return {
...
def amenities_list(request):
    """ Provides a list of available amenities to the context. """
...
def booking_count(request):
    """ Adds the number of total bookings in the site to the context. """
